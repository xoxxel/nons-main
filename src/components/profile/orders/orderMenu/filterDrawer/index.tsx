...
const MenuContents = dynamic(
  () =>
    import("@/components/profile/orders/orderMenu/filterDrawer/menuContent"),
  {
    ssr: false,
    loading: () => (
      <Box
...
const DashboardOrdersFilterMenu = () => {
  ...
  return (
    <>
      ...
      >
        <MenuContents onClose={() => setIsDraweOpen(false)} />
      </SwipeableDrawer>
    </>
  );
};

export default DashboardOrdersFilterMenu;
